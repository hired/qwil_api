...
# Unit tests for QwilAPI::UserCashoutSerializer
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'UserCashoutSerializer' do
  before do
    # run before each test
    @instance = QwilAPI::UserCashoutSerializer.new
  end
  ...
  describe 'test an instance of UserCashoutSerializer' do
    it 'should create an instact of UserCashoutSerializer' do
      expect(@instance).to be_instance_of(QwilAPI::UserCashoutSerializer)
    end
  end
