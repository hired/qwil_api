...
# Unit tests for QwilAPI::ContractorSerializer
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ContractorSerializer' do
  before do
    # run before each test
    @instance = QwilAPI::ContractorSerializer.new
  end
  ...
  describe 'test an instance of ContractorSerializer' do
    it 'should create an instact of ContractorSerializer' do
      expect(@instance).to be_instance_of(QwilAPI::ContractorSerializer)
    end
  end
