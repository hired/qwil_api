...
# Unit tests for QwilAPI::WriteUserCashoutSerializer
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'WriteUserCashoutSerializer' do
  before do
    # run before each test
    @instance = QwilAPI::WriteUserCashoutSerializer.new
  end
  ...
  describe 'test an instance of WriteUserCashoutSerializer' do
    it 'should create an instact of WriteUserCashoutSerializer' do
      expect(@instance).to be_instance_of(QwilAPI::WriteUserCashoutSerializer)
    end
  end
