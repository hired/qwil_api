...
module QwilAPI
  ...
  class IncomeSerializerFixedSource
    attr_accessor :url
    ...
    # The Platform that made this payment to the contractor
    ...
    attr_accessor :payment_time

    attr_accessor :notes

    attr_accessor :imported_time

    # The Invoice in which this Income is to be repaid by the platform.
    attr_accessor :invoice

    # The Rebate in which this Income will be paid to the Contractor.
    attr_accessor :rebate
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'platform_name')
      ...
      if attributes.has_key?(:'payment_time')
        self.payment_time = attributes[:'payment_time']
      end
      ...
      if attributes.has_key?(:'imported_time')
    ...
    def valid?
      ...
      return false if @payment_time.nil?
      return false if @notes.nil?
      return false if @imported_time.nil?
    ...
    def hash
      [url, user, amount, platform, platform_name, external_id, payment_time, notes, imported_time, invoice, rebate].hash
    end
