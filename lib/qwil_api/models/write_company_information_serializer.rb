...
module QwilAPI
  ...
  class WriteCompanyInformationSerializer
    ...
    def hash
      [address_city, address_state, business_name, tax_id_type, phone_number, address_zip_code, tax_id_number, address, email, duns_number].hash
    end
