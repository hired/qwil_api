...
module QwilAPI
  ...
  class WritePersonalInformationSerializer
    ...
    # The Dun and Bradstreet number (D-U-N-S) for this entity
    ...
    def hash
      [date_of_birth, address_city, address_state, tax_id_type, phone_number, address_zip_code, tax_id_number, address, duns_number].hash
    end
