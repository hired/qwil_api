...
module QwilAPI
  ...
  class UserPlatformMembershipRequestSerializer
    attr_accessor :url
    ...
    def self.swagger_types
      {
        :'url' => :'String',
        :'actions' => :'String',
        :'decision_maker' => :'ContactInfoSerializer',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'decision_maker')
    ...
    def hash
      [url, actions, decision_maker, platform_summary, status, platform].hash
    end
