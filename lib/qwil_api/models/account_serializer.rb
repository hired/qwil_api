...
module QwilAPI
  ...
  class AccountSerializer
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'is_tax_savings')
        self.is_tax_savings = attributes[:'is_tax_savings']
      end
    ...
    def list_invalid_properties
      ...
      if @mychoice_user_id.nil?
        invalid_properties.push("invalid value for 'mychoice_user_id', mychoice_user_id cannot be nil.")
      end

      if @mychoice_user_id > 2.147483647E9
        invalid_properties.push("invalid value for 'mychoice_user_id', must be smaller than or equal to 2.147483647E9.")
      end

      if @mychoice_user_id < -2.147483648E9
        invalid_properties.push("invalid value for 'mychoice_user_id', must be greater than or equal to -2.147483648E9.")
      end

      if @mychoice_card_id.nil?
        invalid_properties.push("invalid value for 'mychoice_card_id', mychoice_card_id cannot be nil.")
      end

      if @mychoice_card_id > 9.223372036854776E18
    ...
    def valid?
      ...
      return false if @is_tax_savings.nil?
      return false if @is_paypal.nil?
      return false if @is_mychoice.nil?
      return false if @mychoice_user_id.nil?
      return false if @mychoice_user_id > 2.147483647E9
      return false if @mychoice_user_id < -2.147483648E9
      return false if @mychoice_card_id.nil?
      return false if @mychoice_card_id > 9.223372036854776E18
      return false if @mychoice_card_id < -9.223372036854776E18
    ...
    def mychoice_user_id=(mychoice_user_id)
      if mychoice_user_id.nil?
        fail ArgumentError, "mychoice_user_id cannot be nil"
      end
    ...
    def mychoice_card_id=(mychoice_card_id)
      if mychoice_card_id.nil?
        fail ArgumentError, "mychoice_card_id cannot be nil"
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          is_tax_savings == o.is_tax_savings &&
    ...
    def hash
      [url, account_number, name, routing_number, is_tax_savings, is_paypal, is_mychoice, mychoice_user_id, mychoice_card_id, deleted, user].hash
    end
