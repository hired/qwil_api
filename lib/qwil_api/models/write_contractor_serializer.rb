...
module QwilAPI
  ...
  class WriteContractorSerializer
    attr_accessor :email
    ...
    def self.swagger_types
      {
        ...
        :'personal_information' => :'WritePersonalInformationSerializer',
    ...
    def hash
      [email, first_name, last_name, business_name, contractor_type, personal_information, default_account].hash
    end
