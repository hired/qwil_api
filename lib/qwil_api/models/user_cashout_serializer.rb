...
module QwilAPI
  ...
  class UserCashoutSerializer
    ...
    def type=(type)
      validator = EnumAttributeValidator.new('String', ["CASHOUT", "DEBIT", "REBATE"])
    ...
    def method=(method)
      validator = EnumAttributeValidator.new('String', ["ACH", "CHECK", "WIRE", "PAYPAL"])
    ...
    def status=(status)
      validator = EnumAttributeValidator.new('String', ["REQUESTED", "PENDING", "COMPLETED", "REJECTED"])
    ...
    def hash
      [url, amount, fee, cashout_time, notes, type, method, status, transmit_time, user, rebate, account, incomes].hash
    end
